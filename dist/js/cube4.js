...
if(lang === 'en') {
  ...
  const text1BorderLoader = new THREE.TextureLoader().load( '../img/cube4/eng/About_link.png' );
  ...
  const text2BorderLoader = new THREE.TextureLoader().load( '../img/cube4/eng/Currency_link.png' );
  ...
  const text3BorderLoader = new THREE.TextureLoader().load( '../img/cube4/eng/Trading_link.png' );
...
if(lang === 'ru') {
  ...
  const text1BorderLoader = new THREE.TextureLoader().load( '../img/cube4/ru/About_link.png' );
  const text1Border = new THREE.SpriteMaterial({map: text1BorderLoader});
  myText1 = new THREE.Sprite(text1Border);
  // myText1 = new SpriteText('Accounts →', '0.23', '#1e4ea7');
  const text2BorderLoader = new THREE.TextureLoader().load( '../img/cube4/ru/Currency_link.png' );
  const text2Border = new THREE.SpriteMaterial({map: text2BorderLoader});
  myText2 = new THREE.Sprite(text2Border);
  // myText2 = new SpriteText('Licenses →', '0.23', '#1e4ea7');
  const text3BorderLoader = new THREE.TextureLoader().load( '../img/cube4/ru/Trading_link.png' );
  const text3Border = new THREE.SpriteMaterial({map: text3BorderLoader});
  myText3 = new THREE.Sprite(text3Border);
...
if(lang === 'ar') {
  ...
  const text1BorderLoader = new THREE.TextureLoader().load( '../img/cube4/ar/About_link.png' );
  const text1Border = new THREE.SpriteMaterial({map: text1BorderLoader});
  myText1 = new THREE.Sprite(text1Border);
  // myText1 = new SpriteText('Accounts →', '0.23', '#1e4ea7');
  const text2BorderLoader = new THREE.TextureLoader().load( '../img/cube4/ar/Currency_link.png' );
  const text2Border = new THREE.SpriteMaterial({map: text2BorderLoader});
  myText2 = new THREE.Sprite(text2Border);
  // myText2 = new SpriteText('Licenses →', '0.23', '#1e4ea7');
  const text3BorderLoader = new THREE.TextureLoader().load( '../img/cube4/ar/Trading_link.png' );
  const text3Border = new THREE.SpriteMaterial({map: text3BorderLoader});
  myText3 = new THREE.Sprite(text3Border);
...
if(lang === 'es') {
  ...
  const text1BorderLoader = new THREE.TextureLoader().load( '../img/cube4/es/About_link.png' );
  const text1Border = new THREE.SpriteMaterial({map: text1BorderLoader});
  myText1 = new THREE.Sprite(text1Border);
  // myText1 = new SpriteText('Accounts →', '0.23', '#1e4ea7');
  const text2BorderLoader = new THREE.TextureLoader().load( '../img/cube4/es/Currency_link.png' );
  const text2Border = new THREE.SpriteMaterial({map: text2BorderLoader});
  myText2 = new THREE.Sprite(text2Border);
  // myText2 = new SpriteText('Licenses →', '0.23', '#1e4ea7');
  const text3BorderLoader = new THREE.TextureLoader().load( '../img/cube4/es/Trading_link.png' );
  const text3Border = new THREE.SpriteMaterial({map: text3BorderLoader});
  myText3 = new THREE.Sprite(text3Border);
...
/*const text3BorderLoader = new THREE.TextureLoader().load( '../img/text-back1.png' );
const text3Border = new THREE.SpriteMaterial({map: text3BorderLoader});
myText3 = new THREE.Sprite(text3Border);*/
...
if(lang === 'ru') {
  myText1.scale.set(2, 0.75, 1.5);
  myText2.scale.set(2, 0.75, 1.5);
  myText3.scale.set(2.2, 0.75, 1.5);
}
if(lang === 'ar') {
  myText1.scale.set(1.5, 0.75, 1.5);
  myText2.scale.set(1.5, 0.75, 1.5);
  myText3.scale.set(1.5, 0.75, 1.5);
}
if(lang === 'es') {
  myText1.scale.set(2, 0.75, 1.5);
  myText2.scale.set(2, 0.75, 1.5);
...
// cube12
loader.load('../img/cube4/economy.png',
  function(texture) {
    texture.anisotropy = renderer.getMaxAnisotropy();
    const material12 = [ 
      new THREE.MeshPhongMaterial({color:0x89a33f, transparent:true, opacity:1, side: THREE.DoubleSide}),
      new THREE.MeshPhongMaterial({color:0x89a33f, transparent:true, opacity:1, side: THREE.DoubleSide}), 
      new THREE.MeshPhongMaterial({color:0xc91374e, transparent:true, opacity:1, side: THREE.DoubleSide}),
      new THREE.MeshPhongMaterial({color:0xc91374e, transparent:true, opacity:1, side: THREE.DoubleSide}), 
...
// cube14
loader.load('../img/cube4/ethereum.png',
  function(texture) {
    texture.anisotropy = renderer.getMaxAnisotropy();
    const material14 = [ 
...
// cube10
loader.load('../img/cube4/ethereum2.png',
  function(texture) {
    texture.anisotropy = renderer.getMaxAnisotropy();
    const material10 = [ 
      new THREE.MeshPhongMaterial({color:0x9a82b2, transparent:true, opacity:1, side: THREE.DoubleSide}),
      new THREE.MeshPhongMaterial({color:0x9a82b2, transparent:true, opacity:1, side: THREE.DoubleSide}), 
      new THREE.MeshPhongMaterial({color:0x91374e, transparent:true, opacity:1, side: THREE.DoubleSide}),
      new THREE.MeshPhongMaterial({color:0x91374e, transparent:true, opacity:1, side: THREE.DoubleSide}), 
      new THREE.MeshPhongMaterial({map: texture}), 
      new THREE.MeshPhongMaterial({color:0xcbb143, transparent:true, opacity:1, side: THREE.DoubleSide}), 
    ];
...
function onMouseClick(event) {
  ...
  if (intersects.length > 0) {
    ...
    if(targetLink === 'link1') {
      $('html, body').animate({
        scrollTop: $('#cryptocurrency-2').offset().top
      }, 500);
    }
    if(targetLink === 'link2') {
      $('html, body').animate({
        scrollTop: $('#cryptocurrency-3').offset().top
      }, 500);
    }
    if(targetLink === 'link3') {
      $('html, body').animate({
        scrollTop: $('#cryptocurrency-1').offset().top
      }, 500);
    }
    if(targetLink === 'link4') {
      $('#form').modal('show');
